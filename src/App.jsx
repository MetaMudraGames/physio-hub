      ...
      <main className="max-w-3xl mx-auto px-4 pb-20">
        ...
        >
          ...
          <div className="mt-8 flex gap-6">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-900">12 Topics</p>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-900">4 Systems</p>
        ...
        >
          ...
          <div className="mt-4 flex gap-3">
            <a
              href="https://github.com/MetaMudraGames"
              target="_blank"
